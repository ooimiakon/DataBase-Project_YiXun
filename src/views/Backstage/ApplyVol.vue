  ...
  <el-main style="background-color: rgba(245, 249, 250, 1)">
    <el-card v-if="review_status == 0" style="height: 100%; width: 100%">
      ...
      <el-form
        ...
        label-position="left"
        label-width="100px"
        style="margin-left: 3%; margin-top: 3%; margin-right: 5%"
      >
        <el-form-item label="特长" style="margin-bottom: 3%">
          <el-input
            v-model="apply_content.Specialty"
            :autosize="{ minRows: 5 }"
            type="textarea"
            placeholder="填写你的特长"
          ></el-input>
        ...
        >
          <el-input
            v-model="apply_content.Background"
            :autosize="{ minRows: 10 }"
            type="textarea"
            placeholder="填写你的背景经历"
          ></el-input>
        </el-form-item>

        <el-form-item label="职业" style="margin-bottom: 3%">
          <el-input
            v-model="apply_content.Career"
            :autosize="{ minRows: 3 }"
            type="textarea"
            placeholder="填写你的职业"
          ></el-input>
    ...
    >
    <el-card v-else="review_status == 3" class="card"
      ><div style="margin-top: 200px">
        <span style="font-size: 150%"
          >您的申请已通过！恭喜您成为一名志愿者！</span
        >
      </div></el-card
    >
  </el-main>
...
export default {
  ...
  methods: {
    save() {
      ...
      api
        .userApplyVolunteer(
          this.apply_content.UserId,
          this.apply_content.Specialty,
          this.apply_content.Background,
          this.apply_content.Career
        )
        .then((res) => {
          console.log(res.data);
