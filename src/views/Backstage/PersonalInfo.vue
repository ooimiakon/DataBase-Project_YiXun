          ...
          <el-row :gutter="20" style="margin-top: 30px; margin-bottom: 30px">
            ...
            <el-col :span="10"
              ><el-form-item label="昵称">
                ...
                ></el-input>
                <el-input
                  v-if="!isChange[0] && isEdit"
                  @change="changeBorderColor(0)"
                  v-model="form.user_name"
                  autocomplete="off"
                ></el-input>
                <el-input
            ...
            <el-col :span="10">
              <el-form-item label="电话">
                <el-input
                  v-if="!isEdit"
                  v-model="form.user_phonenum"
                  autocomplete="off"
                  disabled
                ></el-input>
                <el-input
                  v-if="!isChange[1] && isEdit"
                  @change="changeBorderColor(1)"
                  v-model="form.user_phonenum"
                  autocomplete="off"
                ></el-input>
                <el-input
            ...
            <el-col :span="10">
              <el-form-item label="邮箱">
                <el-input
                  v-if="!isEdit"
                  v-model="form.user_mailbox"
                  autocomplete="off"
                  disabled
                ></el-input>
                <el-input
                  v-if="!isChange[2] && isEdit"
                  @change="changeBorderColor(2)"
                  v-model="form.user_mailbox"
                  autocomplete="off"
                ></el-input>
                <el-input
            ...
            <el-col :span="10">
              <el-form-item label="地址">
                ...
                >
                  ...
                  <el-input
                    style="width: auto"
                    v-if="!isChange[3] && isEdit"
                    @change="changeBorderColor(3)"
                    v-model="form.user_address"
                    autocomplete="off"
                  ></el-input>
                  <el-input
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      api.uploadAvator(this.form.user_id, this.form.user_head).then((res) => {
      ...
      api
        .changeUserInfo(
          this.form.user_id,
          this.form.user_name,
          this.form.user_phonenum,
          this.form.user_mailbox,
          this.form.user_province,
          this.form.user_city,
          this.form.user_area,
